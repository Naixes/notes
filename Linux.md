...
**命令行下载命令**  
 ...
 curl：`curl http://www.baidu.com # 将内容都显示出来 curl http://www.baidu.com -o xxx.html # 可以下载到本地并且命名`

wget： `wget http://www.baidu.com # 下载百度首页，可以复制下载的连接地址使用wget进行下载`

区别brew，yum，apt-get：包管理，类似npm
...
LAMP体系是绝配（linux，apache，mysql，php）

适合大中小型网站

类C语言

**适用范围：**网站，cms，后台接口，与前端联系紧密
...
**适用范围：**大型网站前后端，后台，桌面程序，嵌入式，追求稳定和安全的商业系统，商业中间件
...
**适用范围：**web开发，后台，图形数学文本处理功能强大，桌面程序
